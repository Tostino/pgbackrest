...
(
    ...
    CFGDEFDATA_OPTION
    (
        CFGDEFDATA_OPTION_NAME("enforce-user")
        CFGDEFDATA_OPTION_REQUIRED(true)
        CFGDEFDATA_OPTION_SECTION(cfgDefSectionGlobal)
        CFGDEFDATA_OPTION_TYPE(cfgDefOptTypeString)
        CFGDEFDATA_OPTION_INTERNAL(false)
        ...
        CFGDEFDATA_OPTION_HELP_SECTION("general")
        CFGDEFDATA_OPTION_HELP_SUMMARY("Enforce the user which is able to run the pgbackrest process.")
        CFGDEFDATA_OPTION_HELP_DESCRIPTION
        (
            "Only allow pgbackrest to run as the specified user. If not specified, there is nothing to enforce and pgbackrest will "
                "run."
        )
        ...
        CFGDEFDATA_OPTION_OPTIONAL_LIST
        (
            CFGDEFDATA_OPTION_OPTIONAL_DEFAULT("")
        )
    )
